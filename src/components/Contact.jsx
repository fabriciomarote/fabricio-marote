        ...
        <>
            ...
            <div className='contact-container' data-theme={theme}>
                ...
                <div className='box-form wow animate__animated animate__zoomIn'>
                    <a href="https://drive.google.com/file/d/1M4t4gMeNHhtiReoUMepGMdFlsrD5xA5C/view?usp=sharing" className='button-contact hvr-sweep-to-right'><IoIosPaper size={30} className="icon-contact"/> Mi Curriculum Vitae</a> 
