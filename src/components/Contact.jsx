        ...
        <>
            ...
            <div className='contact-container' data-theme={theme}>
                ...
                <div className='box-form wow animate__animated animate__zoomIn'>
                    <a href="https://drive.google.com/file/d/1G2flSVyitVMo85QCV5juiW6vlxzHHfIe/view?usp=sharing" className='button-contact hvr-sweep-to-right'><IoIosPaper size={40} className="icon-contact"/> Mi Curriculum Vitae</a> 
